...
if ( ! function_exists( 'fwd_setup' ) ) :
	...
	function fwd_setup() {
		...
		// Portrait Blog Size - 200px width, 250px height, hard crop
			...
			// add_image_size( 'portrait-latest', 400, 200, true );
			add_image_size( 'student-image', 200, 300, true );
			add_image_size( 'blog-image', 300, 200, true );
...
function fwd_scripts() {
	...
	wp_enqueue_style(
		'fwd-googlefonts', 
		'https://fonts.googleapis.com/css2?family=Merriweather:wght@400;700&family=Poppins:wght@400;700&display=swap', 
		array(), 
		null
	);
...
add_action( 'inti', 'fwd_block_editor_templates' );